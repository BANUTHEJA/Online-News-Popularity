...
%% Undestanding the shares of the article
shares = numData(:,end);
...
% 1) No Null values - mentioned in citation of dataset 
% 2) Outliers removal
...
toc
time = toc;
disp('Accuracy of Logistic_Rawdata - With outliers')
disp(acc_5)
disp('Time taken - Logistic_Rawdata - With outliers')
disp(time)
...
toc
time = toc;
disp('Accuracy of KNN_Rawdata - With outliers')
disp(acc_6)
disp('Time taken - KNN  _Rawdata  - With outliers')
disp(time)

% These classifiers takes more time to run, so its better to comment them
% while running the whole code sir

tic
[model_7, acc_7] = trainClassifier_LinearSVM_Raw(z_raw_outliers);
toc
time = toc;
disp('Accuracy of LinearSVM_Rawdata - With outliers')
disp(acc_7)
disp('Time taken - LinearSVM_Rawdata - With outliers')
disp(time)
...
toc
time = toc;
disp('Accuracy of GaussianSVM_Rawdata - With outliers')
disp(acc_8)
disp('Time taken - GaussianSVM_Rawdata - With outliers')
disp(time)
...
toc
time = toc;
disp('Accuracy of Logistic - PCA with Outliers')
disp(acc1)
disp('Time taken - Logistic -PCA with Outliers')
disp(time)
tic
[model2, acc2] = trainClassifierKNNOutliers(trainingData, responseData);
toc
time = toc;
disp('Accuracy of KNN -PCA with Outliers')
disp(acc2)
disp('Time taken - KNN-PCA with Outliers')
disp(time)
...
toc
time = toc;
disp('Accuracy of Logistic -PCA No Outliers')
disp(acc5)
disp('Time taken - Logistic -PCA No Outliers')
disp(time)
tic
[model6, acc6] = trainClassifierKNN(trainingData, responseData);
toc
time = toc;
disp('Accuracy of KNN -PCA No Outliers')
disp(acc6)
disp('Time taken - KNN -PCA No Outliers')
disp(time)
...
toc
time = toc;
disp('Accuracy of LinearSVM - PCA No Outliers')
disp(acc3)
disp('Time taken - LinearSVM -PCA No Outliers')
disp(time)
tic
[model4, acc4] = trainClassifierGuassianSVM(trainingData, responseData);
toc
time = toc;
disp('Accuracy of GaussianSVM -PCA No Outliers')
disp(acc4)
disp('Time taken - GAussianSVM -PCA No Outliers')
disp(time)
